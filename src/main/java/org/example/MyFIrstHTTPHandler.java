...
public class MyFIrstHTTPHandler implements HttpHandler {
    ...
    public ResponseReceivedAction handleHttpResponseReceived(HttpResponseReceived httpResponseReceived) {
        if(httpResponseReceived.initiatingRequest().isInScope() && httpResponseReceived.initiatingRequest().method().equals("POST") && httpResponseReceived.toolSource().isFromTool(ToolType.PROXY)){
            ...
            String result = PtGUtils.analyzeResponse(originalRepeatedHttpRequestResponse.response(), modifiedHttpRequestResponse.response());
